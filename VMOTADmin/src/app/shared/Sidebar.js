    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <a className="sidebar-brand brand-logo text-white  text-decoration-none" href="index.html">VMOT Dashboard</a>
          {/* <a className="sidebar-brand brand-logo-mini" href="index.html"><img src={require('../../assets/images/logo-mini.svg')} alt="logo" /></a> */}
          <a className="sidebar-brand brand-logo-mini text-white text-decoration-none" href="index.html" >VMOT Dashboard</a>
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>Venkatesh Mogili</Trans></h5>
            ...
            <Collapse in={this.state.basicUiMenuOpen}>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={this.isPathActive('/basic-ui/buttons') ? 'nav-link active' : 'nav-link'} to="/basic-ui/buttons"><Trans>JavaScript</Trans></Link></li>
                  <li className="nav-item"> <Link className={this.isPathActive('/basic-ui/dropdowns') ? 'nav-link active' : 'nav-link'} to="/basic-ui/dropdowns"><Trans>NodeJs</Trans></Link></li>
                  <li className="nav-item"> <Link className={this.isPathActive('/basic-ui/typography') ? 'nav-link active' : 'nav-link'} to="/basic-ui/typography"><Trans>HTML5</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
          ...
          <li className="nav-item menu-items">
            <a className="nav-link" href="http://bootstrapdash.com/demo/corona-react-free/documentation/documentation.html" rel="noopener noreferrer" target="_blank">
              ...
              <span className="menu-title"><Trans>Practice Code</Trans></span>
            </a>
          </li>
          ...
          <li className="nav-item menu-items">
            <a className="nav-link" href="http://bootstrapdash.com/demo/corona-react-free/documentation/documentation.html" rel="noopener noreferrer" target="_blank">
              ...
              <span className="menu-title"><Trans>Other Courses</Trans></span>
            </a>
          </li>
